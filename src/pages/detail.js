        ...
        <div >
            <div style={{ display: "flex", margin: "0 4em" }}>
                ...
                <Box sx={{ width: "50%", }} mt={14}>
                    ...
                    <Typography display={"flex"} my={1} fontWeight={600} color="grey.main">TAGS: {item1?.tags?.map((db) => <Typography fontWeight={600} color="grey.main" display={"flex"} >&nbsp;{db}</Typography>)}</Typography>
